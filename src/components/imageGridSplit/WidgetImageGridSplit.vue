  ...
  >
    ...
    >
      <div
        ...
        data-testid="grid-split-preview"
      >
        <img
          :src="inputImageUrl"
      ...
      <div
        ...
        data-testid="grid-split-empty"
      >
        <i class="icon-[lucide--grid-3x3] size-6" />
        {{ $t('imageGridSplit.connectImage') }}
      </div>
    </div>

    <div
      class="text-center text-xs text-muted-foreground"
      data-testid="grid-split-dimensions"
    >
      {{
        $t('imageGridSplit.gridSummary', {
          rows,
          columns,
          tiles: rows * columns
        })
...
import { useImageGridSplit } from '@/composables/imageGridSplit/useImageGridSplit'
